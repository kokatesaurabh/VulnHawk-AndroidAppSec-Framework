...
class Static_AnalyzerAndroid(models.Model):
    class Meta:
        """Meta class for Static_AnalyzerAndroid model."""
...
class Static_AnalyzerIOS(models.Model):
    class Meta:
        """Meta class for Static_AnalyzerIOS model."""
...
class Static_AnalyzerWindows(models.Model):
    class Meta:
        """Meta class for Static_AnalyzerWindows model."""
