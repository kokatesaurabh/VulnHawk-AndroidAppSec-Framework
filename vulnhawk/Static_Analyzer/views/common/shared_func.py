...
from vulnhawk.VulnHawk.security import (
...
from vulnhawk.VulnHawk.views.scanning import (
    add_to_recent_scan,
    handle_uploaded_file,
)
from vulnhawk.Static_Analyzer.views.comparer import (
    generic_compare,
)
from vulnhawk.Static_Analyzer.views.common.entropy import (
    get_entropies,
)
