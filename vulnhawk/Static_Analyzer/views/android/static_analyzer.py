...
from vulnhawk.Static_Analyzer.views.android.xapk import (
    handle_aab,
    handle_split_apk,
    handle_xapk,
)
from vulnhawk.Static_Analyzer.views.android.apk import (
    apk_analysis,
    src_analysis,
)
from vulnhawk.Static_Analyzer.views.android.jar_aar import (
    aar_analysis,
    jar_analysis,
)
from vulnhawk.Static_Analyzer.views.android.so import (
    so_analysis,
)
...
def static_analyzer(request, checksum, api=False):
    ...
    try:
        ...
        app_dic['tools_dir'] = app_dic['dir'] / 'Static_Analyzer' / 'tools'
