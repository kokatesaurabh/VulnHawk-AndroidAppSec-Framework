...
from vulnhawk.Static_Analyzer.views.sast_engine import (
    ChoiceEngine,
    SastEngine,
)
...
from vulnhawk.Static_Analyzer.views.android import (
    sbom_analysis,
)
...
def code_analysis(checksum, app_dir, typ, manifest_file, android_permissions):
    ...
    try:
        root = Path(settings.BASE_DIR) / 'Static_Analyzer' / 'views'
