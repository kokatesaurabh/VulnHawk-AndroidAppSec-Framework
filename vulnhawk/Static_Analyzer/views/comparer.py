...
from vulnhawk.VulnHawk.utils import print_n_send_error_response
...
def generic_compare(request,
    ...
    db_entry = Static_AnalyzerAndroid.objects.filter(MD5=first_hash)
    db_entry2 = Static_AnalyzerAndroid.objects.filter(MD5=second_hash)
