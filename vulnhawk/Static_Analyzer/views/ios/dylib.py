...
from vulnhawk.Static_Analyzer.models import Static_AnalyzerIOS
...
from vulnhawk.Static_Analyzer.views.ios.binary_rule_matcher import (
    binary_rule_matcher,
)
...
def dylib_analysis(request, app_dict, rescan, api):
    ...
    # DB
    ipa_db = Static_AnalyzerIOS.objects.filter(
        MD5=checksum)
