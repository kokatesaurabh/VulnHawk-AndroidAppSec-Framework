...
from vulnhawk.Static_Analyzer.views.common.a import (
    a_analysis,
)
from vulnhawk.Static_Analyzer.views.ios.dylib import (
    dylib_analysis,
)
from vulnhawk.Static_Analyzer.views.ios.ipa import (
    ios_analysis,
    ipa_analysis,
)
...
def static_analyzer_ios(request, checksum, api=False):
    ...
    try:
        ...
        tools_dir = app_dict[
            'directory'] / 'Static_Analyzer' / 'tools' / 'ios'
