...
from vulnhawk.Dynamic_Analyzer.views.android.analysis import (
    generate_download,
    get_screenshots,
    run_analysis,
)
...
from vulnhawk.Dynamic_Analyzer.views.android.tests_frida import (
    apimon_analysis,
    dependency_analysis,
)
...
def view_report(request, checksum, api=False):
    ...
    try:
        ...
        fd_log = os.path.join(app_dir, 'vulnhawk_frida_out.txt')
