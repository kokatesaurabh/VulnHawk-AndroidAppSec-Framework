...
from vulnhawk.Dynamic_Analyzer.forms import UploadFileForm
...
from vulnhawk.Dynamic_Analyzer.views.ios.corellium_ssh import (
    ssh_execute_cmd,
    ssh_file_download,
    ssh_file_upload,
    ssh_jump_host,
)
from vulnhawk.Dynamic_Analyzer.views.ios.corellium_apis import (
    CorelliumAPI,
    CorelliumAgentAPI,
...
def list_apps(request, api=False):
    ...
    try:
        ...
        for i in r.get('apps'):
            ...
            dump_file = Path(
                settings.UPLD_DIR) / checksum / 'vulnhawk_dump_file.txt'
...
def get_container_path(request, api=False):
    ...
    try:
        ...
        cfile = 'vulnhawk_app_container_path.txt'
...
def download_app_data(ci, checksum):
    ...
    container_file = app_dir / 'vulnhawk_app_container_path.txt'
