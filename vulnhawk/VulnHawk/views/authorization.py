...
from vulnhawk.VulnHawk.forms import RegisterForm
...
class Permissions(Enum):
    SCAN = f'Static_Analyzer.{PERM_CAN_SCAN}'
    SUPPRESS = f'Static_Analyzer.{PERM_CAN_SUPPRESS}'
    DELETE = f'Static_Analyzer.{PERM_CAN_DELETE}'
